...
'''
# --------------------------------------------
# training code for DAGN
'''
def main(json_path='options/train_dagn_color.json'):
    '''
    # ----------------------------------------
    # Step--1 (prepare opt)
    # ----------------------------------------
            ...
            if current_step % opt['train']['checkpoint_test'] == 0:
                ...
                for test_data in test_loader:
                    ...
                    try:
                        ...
                        # qf_prob
                        logger.info('predicted quality factor: {:<4.2f}'.format(int(100-torch.argmin(QF))))
                        logger.info('predicted quality factor: {:<4.2f}'.format(int(100-torch.argmax(QF))))
